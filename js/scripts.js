...
var captions = ['Acropolis, Athens', 'centro Storico, Porto', 'Grotto of the Initiates, Sintra'];
...
for(var i = 0, i < thumbs.length; i++){
  ...
  thumbs[i].addEventListener('click', nextPhotoById, false);
